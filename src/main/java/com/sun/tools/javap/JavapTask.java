...
//        },
    ...
    protected int writeClass(ClassWriter classWriter, String className)
        ...
        ClassWriter cw = ClassWriter.instance(context);
        cw.setClassFile(cf);
        ...
        System.out.print(gson.toJson(cf.getName()));
        System.out.print(",\n");
        
        System.out.print("\"superClassName\":");
        System.out.print(gson.toJson(cf.getSuperclassName()));
        System.out.print(",\n");
        
        System.out.print("\"interfaces\":[");        
        for (int i = 0; i < cf.interfaces.length; i++) {
            System.out.print(gson.toJson(cw.getJavaInterfaceName(cf, i)));
            if (i < cf.interfaces.length-1) System.out.print(",");
        }        
        System.out.print("],\n");
        
        System.out.print("\"accessFlags\":");
        System.out.print(gson.toJson(cf.access_flags.getClassModifiers()));
        System.out.print(",\n");
        
//        System.out.println("\"attributes\":");
//        System.out.print(gson.toJson(cf.attributes));
//        System.out.print(",\n");
        
        System.out.println("\"fields\":[");
        //System.out.print(gson.toJson(cf.fields));
...
//        System.out.print(gson.toJson(cf.methods));
//        System.out.print(",\n");
        ...
        for (int i = 0; i < cf.methods.length; i++) {
            ...
            try {
                cw.writeJsonMethod(m);
            } catch (Exception e) {
                throw new RuntimeException(cf.getName(), e);
            }
            
            if (i < cf.methods.length-1) System.out.print(",");
        }
        System.out.print("]\n");
